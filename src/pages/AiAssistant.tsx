        ...
        {messages.map((m, i) => (
          <div key={i} className="space-y-4">
            ...
            >
              ...
              <div className={`max-w-[85%] p-4 rounded-[1.8rem] text-sm leading-relaxed font-medium shadow-xl ${m.role === "user" ? "bg-[#00A86B] text-white rounded-tr-none" : "bg-[#0C1F1A] border border-[#1A3D2E] rounded-tl-none text-slate-100"}`}>
