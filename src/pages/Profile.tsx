      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-4 py-4">
        ...
        <FadeUp>
          <div className="space-y-2 mb-6">
            <Card variant="default" className="flex items-center gap-3 py-3"><Phone className="w-5 h-5 text-[#7C3AED]" /><span className="flex-1 text-sm">Телефон</span><span className="text-sm text-slate-400">+998 __ ___ __ __</span></Card>
