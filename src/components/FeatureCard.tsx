...
export function FeatureCard({
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className="group text-left p-6 rounded-3xl bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl border border-slate-200/60 dark:border-slate-700/60 shadow-lg hover:shadow-2xl transition-shadow duration-300"
    >
