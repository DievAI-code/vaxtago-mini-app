...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-6 z-[100] pointer-events-none pb-[calc(1.5rem+env(safe-area-inset-bottom))]">
      <nav className="mx-auto flex items-center justify-around px-2 py-3 bg-[#0C1F1A]/95 backdrop-blur-3xl border border-[#1A3D2E] rounded-[2.5rem] w-full max-w-lg pointer-events-auto shadow-[0_-10px_40px_rgba(0,0,0,0.6)]">
        {ITEMS.map((item) => {
            ...
            >
              {active && (
                <motion.div
                  ...
                  className="absolute -inset-2 bg-[#00A86B]/20 rounded-2xl blur-md"
                />
              )}
              <motion.div
                animate={{ 
