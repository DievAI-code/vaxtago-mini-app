...
async def cmd_about(message: Message, tg_user: dict | None):
    ...
    about_text = (
        f"О проекте\n\n"
        "VAQTA AI — это платформа, созданная для помощи мигрантам в адаптации и успешной работе в России. Мы объединяем передовые технологии искусственного интеллекта с глубоким пониманием потребностей наших пользователей.\n\n"
        "Наша миссия:\n"
        "Помочь migrant workers безопасно находить работу, понимать документы, общаться без языковых барьеров и защищать себя от мошенничества и эксплуатации.\n\n"
        "Ключевые функции:\n"
